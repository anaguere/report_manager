...
class NewsDetail extends Connector{
	...
	public function __construct($news_det_date,$news_det_id,$news_det_image,$news_det_source,$news_det_text){
		$connector = Connector::ConexionBD();
		$this->attr_connector = $connector['conexion'];
		$this->table_name ="news_detail";
		$seleccion;
		if($news_det_date != null || $news_det_id != null || $news_det_image != null || $news_det_source != null || $news_det_text != null ){
