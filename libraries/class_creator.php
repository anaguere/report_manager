...
foreach ($json_db as $clave => $valor) {
    ...
    foreach ($valor as $const_def => $const_val) {
        ...
        $class_define .= "\t\t\t\t\t\$field = \"".$const_def."\";".$bl;
        $class_define .= "\t\t\t\t\t\$value = \$".$const_def.";".$bl;
        $class_define .= "\t\t\t}".$bl;
    }
    $class_define .= "\t\t\t\$this->objeto = Connector::SelectIn(\$this->attr_connector, \$this->table_name, \$field, \$value);".$bl;
    $class_define .= "\t\t}".$bl;
    ...
    $class_define .= "\t\t return Connector::SelectIn(\$this->attr_connector,\$this->table_name,\$this->field,\$this->value);".$bl;
    $class_define .= "}".$bl;
