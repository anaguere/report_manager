        ...
        function searchNews(news_id){
            $.post("../controller/news_detail_controller.php",
                ...
                $("#panel0006 #h5_title").append("<div style='width:100%; margin-top:10px;'><img style='text-align:center; margin-top:50px;margin-bottom:50px' width='100%' src='data:application/pdf;base64,"+n.news_det_image+"' ></div>");
                ...
                $('#news_title_prev').text(n.news_det_tit);
                $('#news_body_prev').text(n.news_det_tit);
        ...
        $('#panel0004').hide();
        $('#panel0006').show();
        $('#bottom0004').removeClass('active');
        $('#bottom0006').addClass('active');
