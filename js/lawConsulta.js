...
function searchLaw(idioma){
  ...
  $.post("../controller/law_detail_controller.php",{
    ...
    $.each(laws.contenido,function(i,n){
     ...
     $("#bodyTable").append("<tr style='width:100px' id="+n.law_det_id+" ><td>"+n.law_det_date+"</td><td>"+n.law_det_type+"</td><td>"+n.law_det_name+"</td><td style='width:150px'><a  onclick='editar_law("+n.law_det_id+")'  class='fa fa-edit tam26'></a> <a  onclick='searchlawIndividual("+n.law_det_id+")'  class='fa fa-eye tam26' ></a> <a onclick=print_ley("+n.law_det_id+")> <i class='fa fa-print tam26'></i> </a> <a onclick=deletelaw("+n.law_det_id+")> <i class='fa fa-trash tam26'></i> </a>  </td></tr>");

      $("#col_izquierda").append("\
        <div style='width:100%;margin-bottom:10px; font-size:20px; font-weigth:bold; line-height: 22px'>"+n.law_det_type+"</div>\
  ...
  $.post("../controller/law_detail_controller.php",{
    ...
    $.each(laws_detail.contenido, function(i,n){
      ...
      $("#col_izquierda_individual").append("\
        ...
        <div style='width:100%;margin-bottom:10px; text-align:justify;'>Date<b>"+n.law_det_date+".- </b>"+n.law_det_type+"</div>\
        ");
